...
Crafty.c("Text", {
	...
	init: function() {
		this.bind("Draw", function(e) {
			if(e.type === "DOM") {
				...
				c.fillText(this._text,this._x, this._y+20);
			}
		});
	},
	 ...
	 * @param text -
	 *            String of text that will be inseretd into the DOM element. Can
	 *            use HTML. This method will update the text inside the entity.
	 *            To modify the font, use the `.css` method inherited from the
	 *            DOM component.
	 */
	text: function(text) {
